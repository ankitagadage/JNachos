...
public abstract class JNachos {
	...
	private static LinkedList<Integer> procTableList;
	
	private static LinkedList<JoinProcessTable> waitTableList;
	
	public static HashMap<Integer, NachosProcess> globalProcTable;

	public static int swapCounter = 0;

	public static int pageFaultCounter = 0;
	/**
	 * File to write the pages in the swap space
	 * */
	public static OpenFile swapFile;
	
	/**
	 * List to implement the FIFO page replacement policy
	 * */
	public static LinkedList<Integer> fifoList;
	
	public static HashMap<Integer, TranslationEntry> frameNumToTransEntryMap;
	
	public static synchronized LinkedList<Integer> getProcessIdList() {
		return procTableList;
	}
	...
	public static void initialize(String args[]) {
		...
		procTableList = new LinkedList<Integer>();
		setmJoinData(new LinkedList<JoinProcessTable>());  
		...
		JNachos.globalProcTable = new HashMap<>();
		
		
		mFileSystem = new JavaFileSystem(format);

		fifoList = new LinkedList<>();
		frameNumToTransEntryMap = new HashMap<>();
		
		mFileSystem = new JavaFileSystem(format);
		mFileSystem.create("swapSpaceFile", 2048);
		JNachos.swapFile = mFileSystem.open("swapSpaceFile");
		System.out.println("***Swap Space created successfully on the disk***");
		/*
	...
	public static void setSwapCounter(int swapCounter) {
		JNachos.swapCounter = swapCounter;
	}
	...
	public static LinkedList<JoinProcessTable> getmJoinData() {
		return waitTableList;
	}

	public static void setmJoinData(LinkedList<JoinProcessTable> mJoinData) {
		JNachos.waitTableList = mJoinData;
	}
