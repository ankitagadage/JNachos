...
public class Machine {
	...
	public static final int NumPhysPages = 64;
	...
	/**
	 * The hardware timer. This class can throw interrupts at schedulable
	 * intervals.
	 */
	...
	public static Integer readMem(int addr, int size) {
		...
		//System.out.println("RMem: addr:" + addr + " pAdd:" + physicalAddress);
...
//			return null;
//		}else if (exception != ExceptionType.NoException) {
...
//		}
	...
	public static boolean writeMem(int addr, int size, int value) { 
		...
		//System.out.println("WMem: addr:" + addr + " pAdd:" + physicalAddress[0]);
