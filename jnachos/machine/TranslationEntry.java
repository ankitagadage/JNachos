...
public class TranslationEntry {
	...
	public int getSwapSpacePageLocation() {
		return swapSpacePageLocation;
	}

	public void setSwapSpacePageLocation(int swapSpacePageLocation) {
		this.swapSpacePageLocation = swapSpacePageLocation;
	}
